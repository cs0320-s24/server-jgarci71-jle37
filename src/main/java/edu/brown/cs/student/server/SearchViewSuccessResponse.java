...
public record SearchViewSuccessResponse(String response_type, SearchViewResponseData responseMap) {
    ...
    public SearchViewSuccessResponse(SearchViewResponseData data){ this("success", data); }

    String serialize(){
        try {
            Moshi moshi = new Moshi.Builder().build();
            JsonAdapter<SearchViewSuccessResponse> adapter = moshi.adapter(SearchViewSuccessResponse.class);
